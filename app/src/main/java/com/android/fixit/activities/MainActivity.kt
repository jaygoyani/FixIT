...
import com.android.fixit.databinding.ActivityMainBinding
import com.android.fixit.fragments.HomeFragment
import com.android.fixit.fragments.ServicesFragment
import com.android.fixit.fragments.UsersFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_services, R.id.nav_users, R.id.nav_profile, R.id.nav_feedbacks
            ), drawerLayout
        )
    ...
    private fun logout() {
        Helper.unSubscribeToTopic(Constants.TOPIC_ADMIN)
    ...
    private fun initialise() {
        ...
        headerView.findViewById<TextView>(R.id.info).text =
            "${user.role} ${Constants.DOT} ${user.countryCode}-${user.mobileNumber}"
    }
